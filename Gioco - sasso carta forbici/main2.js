...
//e lo faccio tramite una funzione
function generate_random_number() {
  var random = Math.floor(Math.random()* 3);
  return random;
}
//richiamo la funzione generate_random_number sia per giocatore_1 che giocatore_2
var giocatore_1 = generate_random_number();
var giocatore_2 = generate_random_number();
